...
# Plot a histogram of the Global Active Power vs Datetime using png device
png(file = "plot1.png")
hist(Feb2days$Global_active_power, col = "red", main = paste("Global Active Power"), xlab = "Global Active Power (kilowatts)", ylab = "Frequency")
dev.off()
